...
Необходимо создать SPA в который будут загружаться данные из файла list.json. 
Данные из файла необходимо отобразить в виде таблицы: ![table-example](table-example.png)

- В таблице должно выводиться только по 25 элементов
